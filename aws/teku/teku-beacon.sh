/home/ec2-user/teku/build/install/teku/bin/teku \
--network=pyrmont \
...
--rest-api-enabled --rest-api-host-allowlist="*" \
--rest-api-cors-origins="*" \
--metrics-enabled --metrics-host-allowlist="*" --metrics-interface="0.0.0.0" \
--logging=INFO
